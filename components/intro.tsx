        ...
        <section
            ...
            >
                <span className="font-bold">
                    Hello, I'm Tampong.</span> I'm a{" "}
                <span className="font-bold">
                    full-stack developer</span> with{" "}
                <span className="font-bold">
                    1 years</span> of experience. I enjoy
                building <span className="italic">
            ...
            <motion.div className='flex flex-col sm:flex-col md:flex-row items-center justify-center gap-2 px-4 text-lg font-medium'
                initial={{ opacity: 0, y: 100 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            >
                ...
                <a
                    className='group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-105  active:scale-105 transition cursor-pointer border border-black/10'
                    href='/resume tampong 2024.pdf'
                    download
                >
                    Download Resume{" "}
                ...
                <div
                    className='flex flex-row items-center justify-center gap-2 text-lg font-medium'
                >
